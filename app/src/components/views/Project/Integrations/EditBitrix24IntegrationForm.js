...
class EditBitrix24IntegrationForm extends React.Component {
  state = {
    sending: false,
    integrationState: (this.props.project && this.props.project.integrations.bitrix24) ? this.props.project.integrations.bitrix24.state : 0
  }
  showSending() {
        ...
        <div className="app-form-fields">
          <Form.Item label="Состояние" className="app-form-field">
            {form.getFieldDecorator('state', {
              initialValue: (project && project.integrations.bitrix24) ? project.integrations.bitrix24.state.toString() : '0',
