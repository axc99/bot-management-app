  ...
  async send (data) {
    ...
    if (data.email == 'ivanov@gmail.com') {
      Modal.error({
        ...
        content: 'Пользователь с такой почтой уже существует в системе'
      })
    } else {
      Modal.success({
    ...
    return (
      <Form hideRequiredMark='false' onSubmit={this.handleSubmit} layout='vertical' className='app-form'>
        ...
        <div className='app-form-btns'>
          <Button loading={this.state.loading} className='app-form-btn' type='primary' htmlType='submit' size='large'>Создать аккаунт</Button>
        </div>
      </Form>
    )
  }
